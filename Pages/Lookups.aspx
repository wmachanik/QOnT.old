<%@ Page Title="Lookups" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="True" CodeBehind="Lookups.aspx.cs"
   Inherits="QOnT.Pages.Lookups" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="cntLookupBdy" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <asp:Label ID="lblStatus" runat="server" />
    <ajct:TabContainer ID="tabcLookup" runat="server" ActiveTabIndex="2" >
    ...
    <ajct:TabPanel ID="tabpnlPeople" runat="server" HeaderText="People">
    ...
    <ajct:TabPanel ID="tabpnlEquipment" runat="server" HeaderText="Equipment">
      <ContentTemplate>
    ...
    <ajct:TabPanel ID="tabpnlCities" runat="server" HeaderText="Cities">
      <ContentTemplate>
        ...
        <asp:ObjectDataSource ID="odsCities" runat="server" 
          DataObjectTypeName="QOnT.DataSets.LookUpDatSets+CityTblDataTable" 
          OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" 
          TypeName="QOnT.DataSets.LookUpDatSetsTableAdapters.CityTblTableAdapter" 
          UpdateMethod="Update"></asp:ObjectDataSource>
      </ContentTemplate>
    </ajct:TabPanel>
    <ajct:TabPanel ID="TabPanel1" runat="server" HeaderText="TabPanel1">
    </ajct:TabPanel>
  </ajct:TabContainer>

  <asp:ObjectDataSource ID="odsEquipTypes" runat="server" TypeName="QOnT.control.EquipTypeTbl" 
      SortParameterName="SortBy" SelectMethod="GetAll" DataObjectTypeName="QOnT.control.EquipTypeTbl"
