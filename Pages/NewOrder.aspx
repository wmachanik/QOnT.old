<%@ Page Language="C#"  MasterPageFile="~/Site.Master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeBehind="NewOrder.aspx.cs" Inherits="QOnT.Pages.NewOrder" %>
        ...
        <Fields>
          ...
          <asp:TemplateField HeaderText="Order Date" SortExpression="OrderDate">
            <EditItemTemplate>
              ...
              <ajc1:CalendarExtender ID="tbxOrderDate_CalendarExtender" runat="server" Enabled="True"
                TargetControlID="tbxDetailOrderDate">
              </ajc1:CalendarExtender>
            </EditItemTemplate>
            <InsertItemTemplate>
              <asp:TextBox ID="tbxDetailOrderDate" runat="server" Text='<%# Bind("OrderDate", "{0:d}") %>' />
              <ajc1:CalendarExtender ID="tbxOrderDate_CalendarExtender" runat="server" Enabled="True"
          ...
          <asp:TemplateField HeaderText="Roast Date" SortExpression="RoastDate">
            <EditItemTemplate>
              ...
              <ajc1:CalendarExtender ID="tbxRoastDate_CalendarExtender" runat="server" Enabled="True"
          ...
          <asp:TemplateField HeaderText="Required By" SortExpression="RequiredByDate">
            <EditItemTemplate>
              ...
              <ajc1:CalendarExtender ID="tbxRequiredByDate_CalendarExtender" runat="server" Enabled="True"
