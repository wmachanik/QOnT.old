<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Customers.aspx.cs" Inherits="QOnT.Pages.Customers" %>
...
<asp:Content ID="cntCustomersBdy" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <asp:UpdatePanel ID="upnlCustomerSummary" runat="server" >
    ...
    <asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="False" CssClass="TblDetailZebra"
      AllowSorting="True" DataSourceID="odsCustomerSummarys" AllowPaging="True" 
    PageSize="25" >
    <Columns>
      <asp:HyperLinkField DataNavigateUrlFields="CustomerID" HeaderText="Edit" ItemStyle-HorizontalAlign="Center"
          DataNavigateUrlFormatString="~/Pages/CustomerDetails.aspx?ID={0}&" Text="edit" />
      ...
      <asp:HyperLinkField DataNavigateUrlFields="CustomerID" HeaderText="Order" ItemStyle-HorizontalAlign="Center" 
          DataNavigateUrlFormatString="~/Pages/NewOrderDetail.aspx?CoID={0}&LastOrder=Y" Text="add last" />
    </Columns>
  ...
  <asp:ObjectDataSource ID="odsCustomerSummarys" 
    TypeName="QOnT.control.CustomerSummaryDAL"
    ...
    <SelectParameters>
      ...
      <asp:SessionParameter DefaultValue="" Name="WhereFilter" 
        SessionField="CustomerSummaryWhereFilter" Type="String" />
    </SelectParameters>
