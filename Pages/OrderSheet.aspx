<%@ Page Title="Order Summary Sheet" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OrderSheet.aspx.cs" Inherits="QOnT.Pages.OrderSheet" %>
...
<asp:Content ID="cntOrderSheetBdy" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <asp:UpdateProgress ID="uprgOrderEditDetail" runat="server" AssociatedUpdatePanelID="upnlButtonBar" >
    <ProgressTemplate>
      <img src="../images/animi/QuaffeeProgress.gif" alt="updating" />&nbsp;...</ProgressTemplate>
  </asp:UpdateProgress>
  ...
  <asp:ObjectDataSource ID="odsOrderSheet" runat="server" 
    ...
    TypeName="QOnT.DataSets.OrderSheetTableAdapters.OrderSheetTableAdapter">
    <SelectParameters>
