<%@ Page Title="Tracker Client Dump" Language="C#" MasterPageFile="~/Site.Master" MaintainScrollPositionOnPostback="true" 
  AutoEventWireup="true" CodeBehind="ClientList.aspx.cs" Inherits="QOnT.Pages.ClientListForm"  %>
...
<asp:Content ID="cntClientDump" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <ContentTemplate>
      <asp:Panel id="pnlSentEmail" runat="server" Visible="false">
        <table class="InputFrm" >
          ...
          <tr>
            <td colspan="5"><cc1:Editor ID="edtBody" runat="server" Height="15em" /></td>
          </tr>
          <tr>
            <td colspan="5" >&nbsp;</td>
          </tr>
  ...
  <asp:ObjectDataSource ID="odsCustomers" runat="server" 
    ...
    TypeName="QOnT.DataSets.CustomersDataSetTableAdapters.CustomersTableAdapter">
    <SelectParameters>
